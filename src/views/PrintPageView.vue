<template>
    ...
    <div class="card noprint" style="margin-bottom:20px">
      ...
      <div class="card-body">
        <div class="row">
          <h5 class="card-text col-md-6">隊伍名稱 | {{initData[0]}}</h5>
          <h5 class="card-text col-md-6">隊伍天數 | {{initData[1]}}天</h5>
          <h5 class="card-text col-md-6">隊伍人數 | {{initData[2]}}人</h5>
          <h5 class="card-text col-md-6">最高海拔高度 | {{initData[3]}} M</h5>
        </div>
      </div>
    </div>
    <h4 class="print" style="font-weight: 600;">隊伍名稱：{{initData[0]}} ｜ 隊伍天數：{{initData[1]}}天 ｜ 隊伍人數：{{initData[2]}}人 ｜ 最高海拔高度：{{initData[3]}} M </h4>
    <div class="row">
        <div class="col-md-9">
